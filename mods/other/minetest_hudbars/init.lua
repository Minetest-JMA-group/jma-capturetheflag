...
ctf_settings.register("hudbars:use_hudbars", {
	...
	on_change = function(player, new_value)
		core.chat_send_player(player:get_player_name(), "Please reconnect to apply setting: \"Use modern hudbars instead of icon hud\"")
	end,
})