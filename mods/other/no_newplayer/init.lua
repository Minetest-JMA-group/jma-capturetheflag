...
core.register_on_prejoinplayer(function(name, ip)
	if no_new_players and core.get_auth_handler().get_auth(name) == nil then
...
core.register_chatcommand("no_newplayers", {
	...
	func = function(name, param)
		if param then
			...
			elseif not param:find("s") and not param == "" then
				return false, core.colorize("#ad00af", "Usage: /no_newplayers [yes/no/show]")
			end
		end

		return true, core.colorize(
			"#ad00af",
