local modpath = core.get_modpath("inventory_admin")
...
core.register_privilege("invmanage", {
...
core.register_chatcommand("invmanage", inv_cmd_def)
...
local function sync_inventories()
    for _, player in ipairs(core.get_connected_players()) do
        ...
        --core.log("action", "Syncing inventory of player: " .. player_name)
