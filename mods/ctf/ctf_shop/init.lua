...
local shop_items = {
    ...
    {item_string = "ctf_map:reinforced_cobble 40", price = 20, modes = modes_all},
    ...
    {item_string = "default:acacia_tree 32", price = 5, modes = modes_all},
    {item_string = "default:acacia_wood 32", price = 5, modes = modes_all},
    {item_string = "default:aspen_tree 32", price = 5, modes = modes_all},
    {item_string = "default:aspen_wood 32", price = 5, modes = modes_all},
    {item_string = "default:pine_tree 32", price = 5, modes = modes_all},
    {item_string = "default:pine_wood 32", price = 5, modes = modes_all},
    {item_string = "default:tree 32", price = 5, modes = modes_all},
    {item_string = "default:wood 32", price = 5, modes = modes_all},

    {item_string = "ctf_healing:heal_block", price = 100, modes = modes_all},
    {item_string = "ctf_landmine:landmine 20", price = 40, modes = modes_all},
    {item_string = "ctf_teams:door_steel 4", price = 20, modes = modes_all},
    {item_string = "ctf_map:spike 25", price = 20, modes = modes_all},
    {item_string = "xpanes:bar_flat 32", price = 10, modes = modes_all},

    --healing
    {item_string = "ctf_healing:medkit", price = 20, modes = modes_all},
    {item_string = "easter_egg:egg", price = 25, modes = modes_all},
    {item_string = "ctf_healing:bandage", price = 15, modes = modes_all},
    {item_string = "ctf_map:apple 32", price = 40, modes = modes_without_nade_fight},
    {item_string = "farming:bread 16", price = 95, modes = modes_all},
    --diamond
    ...
    {item_string = "ctf_ranged:assault_rifle_loaded", price = 50, modes = modes_all},
    {item_string = "ctf_ranged:rifle_loaded", price = 40, modes = modes_all},
    {item_string = "ctf_ranged:pistol_loaded", price = 10, modes = modes_all},
    --nice to have
    {item_string = "ctf_ranged:ammo 5", price = 15, modes = modes_all},
    {item_string = "grenades:frag", price = 25, modes = modes_all},
    {item_string = "wind_charges:wind_charge 32", price = 30, modes = modes_all},
