...
ctf_modebase.register_mode("balanced", {
	treasures = {
		...
		["ctf_mode_nade_fight:pokeball"] = {rarity = 0.4, max_stacks = 1},

		["ctf_melee:sword_rick_astley"] = {rarity = 0.2, max_stacks = 2}
	},
	crafts = {"ctf_ranged:ammo", "ctf_melee:sword_steel", "ctf_melee:sword_mese", "ctf_melee:sword_diamond"},
	physics = {sneak_glitch = true, new_move = false},
	team_chest_items = {"default:cobble 99", "default:wood 99", "default:torch 30", "ctf_teams:door_steel 15"},
	rankings = rankings,
	...
	stuff_provider = function()
		return {"default:sword_stone", "default:pick_stone", "default:torch 15", "default:stick 99"}
	end,
