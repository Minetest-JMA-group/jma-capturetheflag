...
return {
	...
	{
		itemname = "ctf_mode_nade_fight:grenade_tool_3",
		chance = 2,
		amount = 1,
		oneshot = true,
	},
	...
	{
		chance = 30,
		image = "random_gifts_push.png",
		oneshot = true,
		func = function(player)
			player:add_velocity(
				vector.new(math.random(0, 80), math.random(0, 30), math.random(0, 80))
			) --launch to the sky!
		end,
	},
}
