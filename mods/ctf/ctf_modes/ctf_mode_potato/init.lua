...
ctf_modebase.register_mode("potato", {
	treasures = {
		...
		["ctf_mode_potato:potatone"] = {
			max_count = 20,
			rarity = 0.3,
			max_stacks = 1,
		},

		["ctf_mode_potato:compressor"] = { rarity = 0.3, max_stacks = 1 },
		...
		["ctf_mode_potato:potato_launcher"] = { rarity = 0.1, max_stacks = 1 },

		["ctf_mode_potato:potato_grenade"] = { rarity = 0.3, max_stacks = 3 },
